...
export class TipoDocumentoService {
  ...
  listarTipoDocumentoPorId(idTipoDocumento: string) {
    return this.http.get(`${environment.apiURL}/${this.route}/${idTipoDocumento}`);
  }

  eliminarTipoDocumento(idTipoDocumento: string) {
    return this.http.delete(`${environment.apiURL}/${this.route}/${idTipoDocumento}`);
  }
  ...
  actualizarTipoDocumento(tipoDocumento: TipoDocumento, idTipoDocumento:string) {
    return this.http.put(`${environment.apiURL}/${this.route}/${idTipoDocumento}`, tipoDocumento);
  }
}
